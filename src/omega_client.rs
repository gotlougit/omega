...
//!
//! Provides [`OmegaClient`] for RPC-style tool execution over a Unix socket,
//! and proxy implementations of Read, Write, Edit, and Bash that delegate
//! all filesystem / shell work to the daemon.
...
pub mod proxy {
    ...
    use crate::{
        llm::{types::CustomTool, ToolDefinition},
